...
| W2-C4 | **Verify K-Electric Karachi Awards 2025 claim** | ✅ DONE | Claude | **VERIFIED.** Qaisar provided Daily Qaumi Awaz (Hub edition) newspaper clipping showing WANG receiving KHI Awards 2025 on stage with K-Electric branding, “Welfare Association for New Generation” on ceremony display, Khalil Roonjho and Aftab Roonjho receiving award. Article confirms 166+ nominations, 40 categories. English-language outlets didn't cover it — Urdu press did. All 6 file references restored and strengthened with coverage details. |
...
|---|---|---|---|---|
| W2-H1 | **Create `/ai-education-pakistan.html` — AI Education in Pakistan pillar** | ✅ DONE | Codex | Built `/ai-education-pakistan.html` as a 1,300+ word AI education pillar covering the Pakistan landscape (PIAIC, DigiSkills, ACT AI), the Urdu-first access gap, WANG/Urdu AI's differentiators, and direct learn/partner CTAs. Added `Article` + `BreadcrumbList` schema, canonical/OG/Twitter metadata, privacy/footer compliance, and internal links to `blog/ai-education-pakistan.html`, `urduai.html`, `impact.html`, `initiatives.html`, plus supporting journal and about/media pages. |
| W2-H2 | **Create `/our-work-lasbela.html` — WANG in Lasbela, Balochistan** | ✅ DONE | Cursor | **Location authority page.** Only 2–3 competitors for “nonprofit Lasbela” — WANG can dominate. Content: (1) Where is Lasbela — map, context (60% of Balochistan has no internet). (2) WANG's 14-year presence in Ahmed Abad Wang. (3) What WANG does in Lasbela — WALI lab, camps, scholarships, flood relief, climate work. (4) Impact numbers specific to Lasbela. (5) How to visit or partner. Schema: `Article` + `Place` + `BreadcrumbList`. Internal links to: about.html, impact.html, `blog/flood-relief-impact.html`, `blog/lasbela-rising-climate.html`, `blog/girl-rising-lasbela.html`. Target keywords: `nonprofit Lasbela`, `education Lasbela Balochistan`, `NGO Balochistan`, `rural innovation Balochistan`. |
...
| W2-H5 | **Create `/digital-literacy-balochistan.html` — Digital Literacy in Rural Pakistan** | ✅ DONE | Cursor | Content: Contrast WANG's rural, Urdu-first, in-person model vs DigiSkills.pk (3.6M enrolled but urban, English, internet-dependent). WALI lab as physical proof. 1,322 digital skills trainees. Schema: `Article` + `BreadcrumbList`. Target: `digital literacy Balochistan`, `rural digital skills Pakistan`. |
| W2-H6 | **Add partner logo images to homepage** | ✅ DONE | Cursor | Current trust bar is text-only pills. Add actual SVG/PNG logos for: AVPN, Google.org, Internet Society, CAREC. Save to `assets/images/partners/`. Show in a dedicated logo strip on homepage below trust bar. Visual logos convert 5x better than text. Verify: each logo links to the partner's page about WANG (URLs in `MASTER-ADVICE.md` § confirmed citations). |
...
| W2-M6 | **Update team.html — Qaisar's full credentials** | ✅ DONE | Claude | Added: PM Youth Excellence Award 2022 (PM Shahbaz Sharif, International Youth Day), USAID Youth Activist of the Year, Rise Up Youth Champion 2019, Brandeis Heller School alumnus. Updated Person schema with `alumniOf`, `award`, `sameAs` (LinkedIn, X, Rise Up). Awards.html founder section also updated with verified details. |
| W2-M7 | **Replace YouTube iframes with lite-youtube-embed** | ✅ DONE | Cursor | (was S13) Use `lite-youtube-embed` or equivalent facade pattern on `index.html` and `media.html`. Reduces LCP by 2-3 seconds. Import from CDN or bundle locally. Each embed needs: `videoid`, `playlabel`, poster image. |
| W2-M8 | **Add sitemap entries for all new pages** | ✅ DONE | Cursor | After pillar pages are created (W2-H1 through W2-H5), add them to `sitemap.xml` with `<priority>0.8</priority>` and `<changefreq>monthly</changefreq>`. Also add `awards.html` and any new blog posts. |
...
| # | Task | Status | Best for | Details |
|---|---|---|---|---|
| W2-L1 | **Create Wikidata entry for WANG** | ✅ DONE | Claude | Step-by-step instructions written to `WIKIDATA-INSTRUCTIONS.md`. Covers WANG org item (P31, P17, P571, P159, P856, P101, P166, P112) + Qaisar Roonjha person item (human, social entrepreneur, Brandeis alumnus). Includes references, Knowledge Panel context, and common pitfalls. **Qaisar needs to execute manually on wikidata.org.** |
| W2-L2 | **Internal linking audit — every pillar links to 3+ posts, every post links to 1 pillar** | ✅ DONE | Cursor | After pillar pages exist: verify every pillar page links to 3+ supporting blog posts, and every blog post links back to at least 1 pillar page + impact.html + 1 CTA (contact or urduai.org). This is how topic authority works. |
...
| W2-L8 | **Write listicle SEO content** | ✅ DONE | Claude | HANDS and Alkhidmat rank via “Top 10 NGOs in Pakistan” listicle posts. WANG should publish: “AI Education Resources in Urdu — Complete Guide” and/or “Digital Literacy Programs in Balochistan.” These capture informational searches and link to WANG's pillar pages. |
